...
file = open('/home/pi/Desktop/data.txt', 'w')
i2c = busio.I2C(board.SCL, board.SDA, frequency=400000) # setup I2C
mlx = adafruit_mlx90640.MLX90640(i2c) # begin MLX90640 with I2C comm
mlx.refresh_rate = adafruit_mlx90640.RefreshRate.REFRESH_32_HZ#REFRESH_16_HZ # set refresh rate
...
therm1 = ax.imshow(np.zeros(mlx_interp_shape),interpolation='nearest',
                   cmap=plt.cm.jet,vmin=25,vmax=45) # preemptive image
